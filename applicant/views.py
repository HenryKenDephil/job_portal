...
def job_detail(request, slug):
    ...
    return render(request, 'applicant/job_detail.html', {'job': job, 'profile': profile, 'apply_button': apply_button, 'save_button': save_button, 'relevant_jobs': relevant_jobs, 'applicant_navbar': 1})
...
def saved_jobs(request):
    ...
    return render(request, 'applicant/saved_jobs.html', {'jobs': jobs, 'applicant_navbar': 1})
...
def applied_jobs(request):
    ...
    return render(request, 'applicant/applied_jobs.html', {'zipped': zipped, 'applicant_navbar': 1})
